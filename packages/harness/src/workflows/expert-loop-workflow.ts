...
export interface ExpertLoopWorkflowInput {
  content: string;
  projectId?: string;
  stage?: string;
...
export interface ExpertLoopWorkflowState {
 ...
 */
export async function runExpertLoopWorkflow(input: ExpertLoopWorkflowInput): Promise<ExpertLoopWorkflowState> {
 ...
 */
export async function advanceProjectStageWorkflow(
  projectId: string,
  currentStage: string,
  nextStage: string,
  stageArtifacts?: any
