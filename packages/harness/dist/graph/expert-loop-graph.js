...
function createInitialState(input, projectName = 'Unknown Project', stage = 'idea', maxIterations = 3) {
    return {
 ...
 */
async function listenNode(state) {
 ...
 */
export async function runExpertLoopGraph(initialInput, maxIterations = 3, projectName = 'Startup', stage = 'idea') {
 ...
 */
export async function runExpertLoopGraphSimple(initialInput, maxIterations = 3) {
